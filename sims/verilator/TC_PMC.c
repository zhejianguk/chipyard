...
int main(void)
{
  ...
  // Opcode: 0x03
  // Data path: N/U
  ght_cfg_filter(0x01, 0x00, 0x03, 0x01); // lb
  ght_cfg_filter(0x01, 0x01, 0x03, 0x01); // lh
  ght_cfg_filter(0x01, 0x02, 0x03, 0x01); // lw
  ght_cfg_filter(0x01, 0x03, 0x03, 0x01); // ld
  ght_cfg_filter(0x01, 0x04, 0x03, 0x01); // lbu
  ght_cfg_filter(0x01, 0x05, 0x03, 0x01); // lhu
